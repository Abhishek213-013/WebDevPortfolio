...
// ✅ Import image from public folder using BASE_URL
const heroImg = `${import.meta.env.BASE_URL}images/hero-img.jpg`;
    ...
    <section className="py-28 lg:pt-40" id="home">
      ...
      >
        ...
        <motion.div variants={fadeIn}>
          <BackgroundGradient className="w-70 h-70 lg:w-80 lg:h-80 rounded-full bg-zinc-900">
            <figure className="rounded-full overflow-hidden">
              <img src={heroImg} alt="Abhishek Chowdhury" width={452} height={452} />
            </figure>
          </BackgroundGradient>
        </motion.div>
        ...
        <div className="text-center mt-8">
          <motion.h1 variants={fadeInUp} className="text-3xl lg:text-5xl mb-1.5 font-bold">
            Hi, I'm Abhishek Chowdhury.
          </motion.h1>
          ...
          <motion.div variants={fadeInUp} className="mt-10 flex items-center justify-center flex-wrap gap-5">
            <a href={`${import.meta.env.BASE_URL}Abhishek_Chowdhury_CV.pdf`} download>
